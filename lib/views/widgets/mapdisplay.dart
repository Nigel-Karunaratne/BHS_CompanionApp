...
class Floor1StackIcon extends StatefulWidget {
  const Floor1StackIcon({Key? key}) : super(key: key);

  @override
  State<Floor1StackIcon> createState() => _Floor1StackIconState();
}

class _Floor1StackIconState extends State<Floor1StackIcon> {
  @override
  Widget build(BuildContext context) {
    return Stack(
      alignment: Alignment.center,
...
class Floor2StackIcon extends StatefulWidget {
  const Floor2StackIcon({Key? key}) : super(key: key);

  @override
  State<Floor2StackIcon> createState() => _Floor2StackIconState();
}

class _Floor2StackIconState extends State<Floor2StackIcon> {
  @override
  Widget build(BuildContext context) {
    return Stack(
      alignment: Alignment.center,  
